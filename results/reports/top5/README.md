...
![added_latency](../../top5_added_latency.png?v=202607211817)

![rps_max_proxy](../../top5_rps_max_proxy.png?v=202607211817)

![rps_sustained_20ms](../../top5_rps_sustained_20ms.png?v=202607211817)

![memory_rss](../../top5_memory_rss.png?v=202607211817)

![rps_per_dollar](../../top5_rps_per_dollar.png?v=202607211817)

![cost_per_million](../../top5_cost_per_million.png?v=202607211817)
...
<sub>Page + charts regenerated **2026-07-21 18:17 UTC** from the raw `results/*.json`.</sub>
