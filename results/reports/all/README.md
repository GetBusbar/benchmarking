...
⏳ **Pending measurement** (a manifest exists; not yet run on the rig): agentgateway, Busbar, GoModel, LiteLLM · Rust. These land here as their runs complete - nothing is hidden.
...
![memory_rss](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/memory_rss.png?v=202607262137)

![memory_recovery](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/memory_recovery.png?v=202607262137)
