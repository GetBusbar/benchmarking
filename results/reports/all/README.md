...
| [Helicone](https://github.com/Helicone/ai-gateway) | 857 µs | 19.1 ms | 0 | ✕ cannot translate | ✕ no native key governance | n/a |
...
| [LiteLLM · Python](https://github.com/BerriAI/litellm) | 8.8 ms | 2.6 ms | 1 (47 fps) | 490 | ✕ no native key governance | n/a |
| [One-API](https://github.com/songquanpeng/one-api) | 34.6 ms | 5 µs | 32 (1,340 fps) | ✕ cannot translate | ✕ no native key governance | n/a |
...
| [Arch](https://github.com/katanemo/archgw) | 248.1 ms | 235 µs | 1 (42 fps) | 0 | ✕ no native key governance | n/a |
...
![added_latency](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/added_latency.png?v=202607222121)

![rps_max_proxy](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/rps_max_proxy.png?v=202607222121)

![rps_sustained_20ms](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/rps_sustained_20ms.png?v=202607222121)

![memory_rss](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/memory_rss.png?v=202607222121)

![rps_per_dollar](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/rps_per_dollar.png?v=202607222121)

![cost_per_million](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/cost_per_million.png?v=202607222121)

![stream_added_ttft](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/stream_added_ttft.png?v=202607222121)

![stream_added_gap](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/stream_added_gap.png?v=202607222121)

![stream_sustained](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/stream_sustained.png?v=202607222121)

![streamcpu_fps](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/streamcpu_fps.png?v=202607222121)

![xlate_rps_sustained_20ms](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/xlate_rps_sustained_20ms.png?v=202607222121)

![xlate_added_latency](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/xlate_added_latency.png?v=202607222121)

![governed_throughput](https://raw.githubusercontent.com/GetBusbar/benchmarking/main/results/governed_throughput.png?v=202607222121)
...
<sub>Page + charts regenerated **2026-07-22 21:21 UTC** from the raw `results/*.json`.</sub>
